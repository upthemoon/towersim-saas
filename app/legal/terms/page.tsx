    ...
    <div className="bg-paper min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 text-ink">
        ...
        <p className="mt-6 leading-relaxed">
          本利用規約（以下「本規約」）は、吉岡 涼（屋号: Up the Moon、以下「当方」）が提供するクラウドサービス「TowerSim」（以下「本サービス」）の利用条件を定めるものです。利用者は本規約に同意のうえ、本サービスを利用するものとします。なお、2026 年 7 月以降に Up the Moon合同会社へ事業譲渡を予定しており、譲渡時には本規約上の事業者名を変更します。
        </p>
        ...
        <Section title="第2条（定義）">
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>「アカウント」とは、利用者が本サービスを利用するために当方に登録した識別情報をいいます。</li>
        ...
        <Section title="第3条（登録）">
          <ol className="list-decimal pl-6 space-y-2">
            <li>本サービスの利用を希望する者は、当方所定の方法でアカウント登録を行うものとします。</li>
            <li>登録情報に虚偽があった場合、当方は登録の取消し、または本サービスの利用停止を行うことができます。</li>
            <li>利用者は、自身のアカウント情報を厳重に管理し、第三者に利用させてはなりません。アカウントの管理不十分による損害について、当方は責任を負いません。</li>
          </ol>
        </Section>
        ...
        <Section title="第4条（料金・支払）">
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>支払いが完了しなかった場合、当方は本サービスの提供を停止することがあります。</li>
          </ol>
        </Section>
        ...
        <Section title="第7条（禁止事項）">
          ...
          <ul className="list-disc pl-6 space-y-1 mt-2">
            <li>法令・公序良俗に反する行為</li>
            <li>当方、他の利用者または第三者の知的財産権・プライバシーその他の権利を侵害する行為</li>
        ...
        <Section title="第8条（サービスの変更・中断・終了）">
          <ol className="list-decimal pl-6 space-y-2">
            <li>当方は、利用者への事前通知なく本サービスの内容を変更し、または提供を中断・終了することができます。</li>
            <li>本サービスの変更・中断・終了によって利用者に生じた損害について、当方は責任を負いません。</li>
          </ol>
        </Section>

        <Section title="第9条（知的財産権）">
          <p>本サービスおよび本サービスに関連する一切の知的財産権は、当方または正当な権利者に帰属します。利用者は、本サービスを通じて取得したコンテンツを、本サービスの目的外で複製、転用、公衆送信してはなりません。</p>
          <p className="mt-3">利用者が本サービスに入力したデータ（案件情報、計算結果等）の知的財産権は利用者に帰属するものとし、当方はサービス提供に必要な範囲でこれを利用できるものとします。</p>
        </Section>

        <Section title="第10条（免責事項）">
          <ol className="list-decimal pl-6 space-y-2">
            <li>本サービスは、現状有姿で提供されるものであり、当方は本サービスの完全性、正確性、適合性、有用性、安全性等について、明示または黙示を問わず一切の保証をしません。</li>
            <li>本サービスが提供する計算結果は参考情報であり、最終的な判断は利用者の責任において行うものとします。本サービスの計算結果に基づいて行われた契約・取引・経営判断について、当方は責任を負いません。</li>
            <li>当方が利用者に対して負う責任は、当方の故意または重過失による場合を除き、当該損害が発生した月に利用者が当方に支払った料金を上限とします。</li>
          </ol>
        </Section>

        <Section title="第11条（個人情報）">
          <p>当方は、利用者の個人情報を <Link href="/legal/privacy" className="text-rust underline">プライバシーポリシー</Link> に従って取扱います。</p>
        </Section>

        <Section title="第12条（規約の変更）">
          <p>当方は、本規約を変更することができます。変更後の規約は本サービス上に掲載した時点から効力を生じ、その後の本サービスの利用は変更後の規約への同意とみなされます。</p>
        </Section>
